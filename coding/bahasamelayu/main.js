...
document.addEventListener('DOMContentLoaded', () => {
  const start = async () => {
    try {
      ...
      // Load all scenes
      scenes.push(await setupScene(0, '../../assets/models/group2/scene1.glb', '../../assets/sounds/bahasamelayu/bm1.mp3', { x: 0.030, y: 0.030, z: 0.030 }, { x: 0.0, y: -0.2, z: 0 }, { x: 0.0, y: -1.0, z: 0.0 }));
      scenes.push(await setupScene(1, '../../assets/models/group2/scene2.glb', '../../assets/sounds/bahasamelayu/bm2.mp3', { x: 0.030, y: 0.030, z: 0.030 }, { x: 0.0, y: -0.4, z: 0 }, { x: 0.0, y: -1.0, z: 0.0 }));
      scenes.push(await setupScene(2, '../../assets/models/group2/scene3.glb', '../../assets/sounds/bahasamelayu/bm3.mp3', { x: 0.2, y: 0.2, z: 0.2 }, { x: 0.0, y: -0.2, z: 0 }, { x: 0.0, y: -0.7, z: 0.0 }));
      scenes.push(await setupScene(3, '../../assets/models/group2/scene4.glb', '../../assets/sounds/bahasamelayu/bm4.mp3', { x: 0.030, y: 0.030, z: 0.030 }, { x: 0.0, y: -0.4, z: 0 }, { x: 0.0, y: -1.0, z: 0.0 }));
      scenes.push(await setupScene(4, '../../assets/models/group2/scene5.glb', '../../assets/sounds/bahasamelayu/bm5.mp3', { x: 0.2, y: 0.2, z: 0.2 }, { x: 0.0, y: -0.2, z: 0 }, { x: 0.0, y: -0.7, z: 0.0 }));
      scenes.push(await setupScene(5, '../../assets/models/group2/scene6.glb', '../../assets/sounds/bahasamelayu/bm6.mp3', { x: 0.4, y: 0.4, z: 0.4 }, { x: 0.0, y: -2.3, z: 0 }, { x: 0.0, y: -1.2, z: 0.0 }));
      scenes.push(await setupScene(6, '../../assets/models/group2/scene7.glb', '../../assets/sounds/bahasamelayu/bm7.mp3', { x: 0.4, y: 0.4, z: 0.4 }, { x: -1.2, y: -0.8, z: 0 }, { x: 0.2, y: -1.0, z: 0.0 }));
      scenes.push(await setupScene(7, '../../assets/models/group2/scene8.glb', '../../assets/sounds/bahasamelayu/bm8.mp3', { x: 0.4, y: 0.4, z: 0.4 }, { x: -2.0, y: -1.0, z: 0 }, { x: 0.0, y: -1.3, z: 0.0 }));
      scenes.push(await setupScene(8, '../../assets/models/group2/scene9.glb', '../../assets/sounds/bahasamelayu/bm9.mp3', { x: 0.2, y: 0.2, z: 0.2 }, { x: -1.0, y: -0.4, z: 0 }, { x: 0.0, y: 0.0, z: 0.0 }));
      scenes.push(await setupScene(9, '../../assets/models/group2/scene10.glb', '../../assets/sounds/bahasamelayu/bm10.mp3', { x: 0.05, y: 0.05, z: 0.05 }, { x: 0.0, y: -0.4, z: 0 }, { x: 0.0, y: 0.0, z: 0.0 }));
